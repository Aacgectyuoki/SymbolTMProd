    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="container mx-auto p-6">
        ...
        <section className="mb-6">
          ...
          <p><a href="https://www.nocuffs.com" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">www.nocuffs.com</a></p>
          <p><a href="https://www.youtube.com/channel/UCkAyB_BVynRBh_lPxLtnlXA" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">YouTube Channel</a></p>
